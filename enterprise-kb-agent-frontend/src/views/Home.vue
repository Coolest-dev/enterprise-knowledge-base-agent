  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">NexTech 企业知识库</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/knowledge-base')">
        ...
        <div class="app-icon knowledge-base-icon">📚</div>
        <div class="app-info">
          <div class="app-title">企业知识库问答</div>
          <div class="app-desc">基于 RAG 的企业内部知识智能检索与问答</div>
        </div>
...
// 设置页面标题和元数据
useHead({
  title: 'NexTech Solutions 企业知识库问答平台 - 首页',
  meta: [
    {
      name: 'description',
      content: 'NexTech Solutions 企业知识库问答平台提供企业内部知识库智能问答和 AI 超级智能体服务'
    },
    {
      name: 'keywords',
      content: '企业知识库,RAG,AI应用,内部问答,智能对话,NexTech Solutions,AI超级智能体,首页'
    }
  ]
})
